...
const QHash<QString, QHash<QString, QString>> &catalog() {
    static const QHash<QString, QHash<QString, QString>> table = {
        ...
        {QStringLiteral("action.water_area"),
         {{QStringLiteral("zh"), QStringLiteral("水体面积计算...")},
          {QStringLiteral("en"), QStringLiteral("Water Body Area Calculation...")}}},
        {QStringLiteral("action.infrared_spectral"),
         {{QStringLiteral("zh"), QStringLiteral("红外光谱分析...")},
          {QStringLiteral("en"), QStringLiteral("Infrared Spectral Analysis...")}}},
        ...
        {QStringLiteral("dialog.water_area_title"),
         {{QStringLiteral("zh"), QStringLiteral("水体面积计算")},
          {QStringLiteral("en"), QStringLiteral("Water Body Area Calculation")}}},
        {QStringLiteral("dialog.water_area_index"),
         {{QStringLiteral("zh"), QStringLiteral("选择水体指数：")},
          {QStringLiteral("en"), QStringLiteral("Select water index:")}}},
        {QStringLiteral("dialog.water_area_threshold"),
         {{QStringLiteral("zh"), QStringLiteral("水体阈值（指数 ≥ 阈值判为水体）：")},
          {QStringLiteral("en"), QStringLiteral("Water threshold (index ≥ threshold = water):")}}},
        {QStringLiteral("dialog.water_band_green"),
         {{QStringLiteral("zh"), QStringLiteral("Green 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("Green band (1-based):")}}},
        {QStringLiteral("dialog.water_band_nir"),
         {{QStringLiteral("zh"), QStringLiteral("NIR 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("NIR band (1-based):")}}},
        {QStringLiteral("dialog.water_band_swir"),
         {{QStringLiteral("zh"), QStringLiteral("SWIR 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("SWIR band (1-based):")}}},
        {QStringLiteral("dialog.water_area_export_csv"),
         {{QStringLiteral("zh"), QStringLiteral("是否导出统计 CSV？")},
          {QStringLiteral("en"), QStringLiteral("Export statistics to CSV?")}}},
        {QStringLiteral("dialog.water_area_csv_title"),
         {{QStringLiteral("zh"), QStringLiteral("导出水体面积 CSV")},
          {QStringLiteral("en"), QStringLiteral("Export Water Area CSV")}}},
        {QStringLiteral("dialog.infrared_title"),
         {{QStringLiteral("zh"), QStringLiteral("红外光谱分析")},
          {QStringLiteral("en"), QStringLiteral("Infrared Spectral Analysis")}}},
        {QStringLiteral("dialog.infrared_nir_band"),
         {{QStringLiteral("zh"), QStringLiteral("NIR 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("NIR band (1-based):")}}},
        {QStringLiteral("dialog.infrared_swir_band"),
         {{QStringLiteral("zh"), QStringLiteral("SWIR 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("SWIR band (1-based):")}}},
        {QStringLiteral("dialog.infrared_red_band"),
         {{QStringLiteral("zh"), QStringLiteral("Red 波段 (1-based)：")},
          {QStringLiteral("en"), QStringLiteral("Red band (1-based):")}}},
        {QStringLiteral("dialog.infrared_export_csv"),
         {{QStringLiteral("zh"), QStringLiteral("是否导出分析 CSV？")},
          {QStringLiteral("en"), QStringLiteral("Export analysis to CSV?")}}},
        {QStringLiteral("dialog.infrared_csv_title"),
         {{QStringLiteral("zh"), QStringLiteral("导出红外光谱 CSV")},
          {QStringLiteral("en"), QStringLiteral("Export Infrared Spectral CSV")}}},
