...
QString buildApplicationStyle(const ThemeColors &c) {
    return QStringLiteral(R"(
        ...
        QTreeWidget { background-color: %7; color: %2; border: none; outline: none; }
        QTreeWidget::item:selected { background-color: %6; color: #ffffff; }
        QTreeWidget::item:hover { background-color: %4; }
        QHeaderView::section { background-color: %8; color: %2; border: none; padding: 4px 8px; }
        QTextEdit { background-color: %1; color: %9; font-family: Consolas; border-top: 2px solid %6; }
        QTabWidget::pane { background-color: %1; border: 1px solid %5; }
        QTabBar::tab { background: %8; color: %2; padding: 8px 20px; border: 1px solid %5; }
        ...
        QStatusBar { background-color: %11; color: %12; border-top: 1px solid %5; font-weight: normal; }
        ...
        QComboBox QAbstractItemView {
            ...
            selection-color: #ffffff; border: 1px solid %5;
        }
        ...
        QToolTip { background-color: %1; color: %2; border: 1px solid %6; padding: 4px; }
    )")
...
QString buildMainWindowStyle(const ThemeColors &c) {
    return QStringLiteral(R"(
        QMainWindow { background-color: %1; }
        QMenuBar {
        ...
        QTabBar::tab {
            background-color: %8; color: %9; padding: 8px 20px; border: 1px solid %7;
        ...
        QTreeWidget {
            ...
            font-size: 13px; color: %3; alternate-background-color: %1;
        }
        ...
        QTextEdit {
            ...
            font-size: 12px; border: 1px solid %7; border-radius: 4px; padding: 4px;
        }
...
QString AppTheme::applicationStyleSheet() const {
    return buildApplicationStyle(paletteFor(theme_));
}

QString AppTheme::mainWindowStyleSheet() const {
    return buildMainWindowStyle(paletteFor(theme_));
}
